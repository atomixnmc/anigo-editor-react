...
export default class UserPermissionConfigViewRow extends Component {
  static propTypes = {
          ...
          <ButtonGroup>
            <span>
              <DropdownButton id="actionDropdown" className={'item-action'} title={<Glyphicon glyph="option-vertical" />}>
                ...
                {/* <LinkContainer to={'/user-role-edit/' + userPermission.id}>
                  <Dropdown.Item>
                    <span>Edit UserPermission Detail</span>
                  </Dropdown.Item>
                </LinkContainer> */}
                {/* <Confirm
