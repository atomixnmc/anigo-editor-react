...
import * as userGroupActions from 'redux/modules/user-group/user-group-manage';
import { isLoaded, loadPage as loadContents } from 'redux/modules/user-group/user-group-manage';
...
@connect(
  state => ({
    userGroup: state.userGroupManage.data,
    ...
    newId: state.userGroupManage.newId,
...
export default class UserGroupDetail extends Component {
  static propTypes = {
  ...
  render() {
    ...
    const { userGroup, error, editing, loading } = this.props;
