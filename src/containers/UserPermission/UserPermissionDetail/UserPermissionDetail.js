...
import * as userPermissionActions from 'redux/modules/user-permission/user-permission-manage';
import { isLoaded, loadPage as loadContents } from 'redux/modules/user-permission/user-permission-manage';
...
@connect(
  state => ({
    userPermission: state.userPermissionManage.data,
    ...
    newId: state.userPermissionManage.newId,
...
export default class UserPermissionDetail extends Component {
  static propTypes = {
  ...
  render() {
    ...
    const { userPermission, error, editing, loading } = this.props;
          ...
          <div className="container">
            <div className="row">
              <div className="col-sm-8">
                <h1 className="section-header-title">UserPermission</h1>
                <h2 className="section-header-subtitle">UserPermission Detail</h2>
                {error &&
